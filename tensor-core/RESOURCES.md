...
- [NVIDIA CUTLASS — CuTe Layout](https://github.com/NVIDIA/cutlass/blob/main/media/docs/cpp/cute/01_layout.md) — Layout 的 shape/stride、坐标映射、层次结构与 size/cosize 的官方定义。Use for — CuTe 基础与 Layout 读码。
- [NVIDIA CUTLASS — CuTe Layout Algebra](https://github.com/NVIDIA/cutlass/blob/main/media/docs/cpp/cute/02_layout_algebra.md) — composition、coalesce、complement、divide/product 的官方语义。Use for — Layout 代数课程与 API 查证。
- [NVIDIA CUTLASS — CuTe DSL documentation](https://docs.nvidia.com/cutlass/latest/media/docs/pythonDSL/cute_dsl.html) — Python DSL 的官方工作流、编译模型和核心抽象。Use for — CuTe DSL 实操及版本约束查证。
